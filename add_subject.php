                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="subj_desc" class="form-control"> <br>
                                <button type="submit" name="save_subj" class="btn btn-primary btn-block">Save Subject</button>
                            </div>
                        </form>
                        <?php 
                        if(isset($_POST['save_subj'])){
                            $subjName = $_POST['subj_name'];
                            $subjDesc = $_POST['subj_name'];

                            add_subject($subjName,$subjDesc);
                        }
